...
@section('title', 'Klien Badan Usaha')

@section('content')
@include('layouts.navbars.auth.topnav', ['title' => isset($client) ? 'Edit Klien Badan Usaha' : 'Tambah Klien Badan Usaha'])

<div class="row mt-4 mx-4">
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>{{ isset($client) ? 'Edit' : 'Tambah' }} Klien Badan Usaha</h6>
            </div>
