...
class NotaryRelaasAktaController extends Controller
{
    ...
    public function indexNumber(Request $request)
    {
        ...
        if ($request->filled('search')) {
            ...
            $aktaInfo = NotaryRelaasAkta::with(['client', 'akta_type', 'notaris'])
        ...
        return view('pages.BackOffice.RelaasAkta.AktaNumber.index', compact('lastAkta', 'aktaInfo', 'transactions'));
    }
